...
def ESSM(dnn_feature_columns, task_type='binary', task_names=None,
         tower_dnn_units_lists=None, l2_reg_embedding=0.00001, l2_reg_dnn=0,
    ...
    """
    if tower_dnn_units_lists is None:
        tower_dnn_units_lists = [[128, 128], [128, 128]]
