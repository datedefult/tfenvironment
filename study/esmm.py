...
if __name__ == "__main__":
    ...
    a = torch.from_numpy(np.array([[1, 2, 4, 2, 0.5, 0.16],
                                   [4, 5, 3, 8, 0.6, 0.43],
                                   [6, 3, 2, 9, 0.12, 0.32],
                                   [9, 1, 1, 1, 0.12, 0.45],
                                   [8, 3, 1, 4, 0.21, 0.67],
                                   [8, 3, 1, 4, 0.21, 0.67],
                                   [8, 3, 1, 4, 0.21, 0.67]]))
    user_cate_dict = {'user_id': (11, 0,6), 'user_list': (12, 3,78), 'user_num': (1, 4,6)}
    item_cate_dict = {'item_id': (8, 1,6), 'item_cate': (6, 2,3), 'item_num': (1, 5,15)}
    print(user_cate_dict)
    print(item_cate_dict)
